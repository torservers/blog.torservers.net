...
apt-get install python2.7 python2.7-dev virtualenv 
...
Depending on your choice of markup (we do use Markdown for blog.torservers.net):
$ pip install Mardown

To start a pelicanblog use and answer the questions accordingly:
$ pelican-quickstart

Optionally use fabric as automation tool
$ pip install Fabric
